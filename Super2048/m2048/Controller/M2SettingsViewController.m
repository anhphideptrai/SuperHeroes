...
- (void)commonInit
{
  _options = @[@"Game Type", @"Board Size", @"Theme", @"Show Numbers"];
  
  _optionSelections = @[@[@"Powers of 2", @"Powers of 3", @"Fibonacci"],
                        @[@"3 x 3", @"4 x 4", @"5 x 5"],
                        @[@"Vibrant", @"Standard", @"Joyful"],
                        @[@"Off", @"On"]];
  ...
  _optionsNotes = @[@"For Fibonacci games, a tile can be joined with a tile that is one level above or below it, but not to one equal to it. For Powers of 3, you need 3 consecutive tiles to be the same to trigger a merge!",
                    ...
                    @"Choose your favorite appearance and get your own feeling of Heroes 2048! More (and higher quality) themes are in the works so check back regularly!", @"Choose Off to play with characters and On if you want to use numbers instead."];
}
